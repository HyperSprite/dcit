...
exports.dateTimeMod = function (s) {
    ...
    var themin=exports.pad(mydate.getgetMinutes());
    var dateResults = theyear+"-"+themonth+"-"+thetoday+"_"+thehours+"-"+themin;
    return dateResults;
    }
};
...
exports.mTrim = function(current){
    if (typeof current === "undefined"){
        ...
        console.log("mTrim >"+current);
    }
    return current;
};


// strTgs.sTrim( removes spaces, converts to UPPER case
// this cleans up new values removes all spaces, makes them all caps
...
exports.mCleanUp = function(old,current){
    ...
    console.log ("now>"+current);
    if(old==="" && current==""){
        console.log("mCleanup - old=== & new== ");
    }else if (typeof current ==="undefined"){
        console.log("mCleanup - typeof used");
    }else{
        console.log("mCleanup - current trim");
...
exports.clCleanUp = function(old,current){
    ...
    console.log ("now>"+current);
    if(old==="" && current==""){
        console.log("clCleanup - old=== & new== ");
    }else if (typeof current ==="undefined"){
        console.log("clCleanup - typeof used");
    }else{
        console.log("clCleanup - current trim");
...
exports.stcCleanup = function(old,current){
    ...
    console.log ("now>"+current);
    if(old==="" && current==""){
        console.log("stcCleanup - old=== & new== ");
    }else if (typeof current ==="undefined"){
        console.log("stcCleanup - typeof used");
    }else{
        console.log("stcCleanup - current trim");
