...
new Optionsdb({
    ...
    optListArray:['Not yet ordered','Ordered','In transit','Received','Build in Progress','Spare','Ready','In Service','In Service with issues','Spare with issues','Out for RMA','Damaged','Decommissioned','End of Life - Recycled','End of Life - RMA','End of Life - Transfered','Missing'],
    }).save();
new Optionsdb({
