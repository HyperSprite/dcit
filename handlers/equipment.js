...
module.exports.dcEquipAll = (req, res) => {
...
module.exports.dcEquipNew = (req, res, next) => {
...
module.exports.dcEquipView = (req, res, next) => {
      ...
      Models.Systemdb.find({}, 'systemEquipSN systemName systemEnviron systemRole systemStatus modifiedOn', (err, sys) => {
        ...
        Models.Rack.find({}, {'rUs': 1, 'rackUnique': 1, '_id': 0}, {sort: {rackUnique: 1} }, (err, rk) => {
          ...
          context = {
            ...
            equipEOLChecked: strTgs.setCheckBox(eq.equipEOL),
            equipType: eq.equipType,
            equipMake: eq.equipMake,
            equipModel: eq.equipModel,
            equipSubModel: eq.equipSubModel,
...
module.exports.dcEquipEdit = (req, res, next) => {
...
module.exports.dcEquipCopy = (req, res, next) => {
...
module.exports.dcEquipmentPost = (req, res) => {
...
module.exports.dcEquipPortPostAJAX = (req,res) => {
...
module.exports.dcEquipSysPages = (req, res, next) => {
  var context = {};
  var tempSys;
  var re;
...
module.exports.dcEquipSNChangePost = (req, res) => {
...
module.exports.dcEquipDelete = (req, res) => {
...
module.exports.equipSubDelete = (req, res) => {
